...
class Checksum extends Base
{
     ...
     * Require reusable
     *
     * @var int $_require_reusable
     */
    private $_require_reusable_payment;
   ...
   /**
     ...
     * @var int $_require_reusable
     */
    private $_reusable_payment_description;
    ...
    /**
     * Set require reusable
     *
     * @param bool $reusable request a billing agreement from your customer during checkout
     *
     * @return $this
     */
    public function setRequireReusablePayment($reusable)
    {
        $this->_require_reusable_payment = boolval($reusable);

        return $this;
    }
	
    /**
     * Get require reusable
     *
     * @return bool request a billing agreement from your customer during checkout
     */
    public function getRequireReusablePayment()
    {
        return $this->_require_reusable_payment;
    }

	 /**
     * Set reusable payment description
     *
     * @param string $reusable_desc let the customer know why exactly you need them to agree to future payments
     *
     * @return $this
     */
    public function setReusablePaymentDescription($reusable_desc)
    {
        $this->_reusable_payment_description = $reusable_desc;
     ...
     *
     * @return string let the customer know why exactly you need them to agree to future payments
     */
    public function getReusablePaymentDescription()
    {
        return $this->_reusable_payment_description;
    }
