...
class ChecksumTest extends PHPUnit_Framework_TestCase
{
    ...
    public function setGetTest()
    {
        $sample = array(
            ...
            'reusable_payment_description' => 'Please agree to a recurring payment',
		...
		$this->assertEquals($this->_model->getClient(),    $sample['client_id']);
    ...
    public function parameterizeTestCreate(Checksum $model)
    {
        ...
        $parameterArray['reusable_payment_description']    = 'Please agree to a recurring payment';
