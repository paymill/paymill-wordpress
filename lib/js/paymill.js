jQuery(document).ready(function () {
	...
	function bridgePreparePayment(){
		...
		if(jQuery('#paymill_form_credit').is(':visible') || jQuery('#paymill_card_number').val() != '' && (jQuery('#payment_method_paymill').is(':checked') || jQuery('.wgm-second-checkout input[name=payment_method]').val() == 'paymill')){
		...
		}else if(jQuery('#paymill_form_sepa').is(':visible') || jQuery('#paymill_sepa_iban').val() != '' && (jQuery('#payment_method_paymill').is(':checked') || jQuery('.wgm-second-checkout input[name=payment_method]').val() == 'paymill')){
		...
		}else if(jQuery('#paymill_form_elv').is(':visible') || jQuery('#paymill_elv_number').val() != '' && (jQuery('#payment_method_paymill').is(':checked') || jQuery('.wgm-second-checkout input[name=payment_method]').val() == 'paymill')){
