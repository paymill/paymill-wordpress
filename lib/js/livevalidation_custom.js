jQuery(document).ready(function () {
	if(typeof paymill_shop_name != 'undefined'){
		jQuery("body").on("click", "#payment", function() {
			var f0 = new LiveValidation('holdername', { validMessage: "✔", onlyOnBlur: true, failureMessage: paymill_livevl.notEmpty} );
			f0.add( Validate.Presence,{failureMessage: paymill_livevl.notEmpty} );

			var f1 = new LiveValidation('card-number', { validMessage: "✔", onlyOnBlur: true });
			var maximum = 16;
			...
			var f2 = new LiveValidation('card-cvc', { validMessage: "✔", onlyOnBlur: true });
			var maximum = 4;
			var minimum = 3;
			...
			var f3 = new LiveValidation('card-expiry-month', { validMessage: "✔", onlyOnBlur: true });
			var is = 2;
			...
			var f4 = new LiveValidation('card-expiry-year', { validMessage: "✔", onlyOnBlur: true });
			var is = 4;
			...
			var f5 = new LiveValidation('transaction-form-account', { validMessage: "✔", onlyOnBlur: true });
			...
			var f6 = new LiveValidation('transaction-form-code', { validMessage: "✔", onlyOnBlur: true });
			var is = 8;
